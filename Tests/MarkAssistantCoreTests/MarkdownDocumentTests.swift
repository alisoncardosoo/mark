...
struct MarkdownDocumentTests {
    ...
    func registersMarkdownUTType() {
        #expect(UTType.markAssistantMarkdown.identifier == "net.daringfireball.markdown")
        #expect(UTType(filenameExtension: "md")?.identifier == UTType.markAssistantMarkdown.identifier)
        #expect(UTType(filenameExtension: "markdown")?.identifier == UTType.markAssistantMarkdown.identifier)
        #expect(MarkdownDocument.readableContentTypes.contains(.markAssistantMarkdown))
    }
